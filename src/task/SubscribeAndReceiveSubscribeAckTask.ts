...
export default class SubscribeAndReceiveSubscribeAckTask extends BaseTask {
  ...
  async run(): Promise<void> {
    ...
    if (
      this.context.videoDownlinkBandwidthPolicy.wantsServerSideNetworkAdaption !== undefined &&
      this.context.videoDownlinkBandwidthPolicy.wantsServerSideNetworkAdaption() !==
